...
# Include Bricolage Grotesque font files in datas
...
packages_to_collect = ['PyQt6']
if get_platform() == 'linux':
    packages_to_collect.extend(['PyQt6.QtDBus'])
...
for pkg in packages_to_collect:
    try:
        ...
        print(f"Error collecting dependencies for {pkg}: {e}")
        pass

# Add specific imports for pycurl and libarchive without collecting all
...
# Platform-specific modifications to help PyInstaller
if get_platform() == 'linux':
    # For Linux, make sure PyInstaller can find libraries
    if 'LD_LIBRARY_PATH' in os.environ:
    ...
    # For macOS, help PyInstaller find frameworks
